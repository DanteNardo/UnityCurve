...
namespace UnityCurve.UI {
	...
	/// elements and rendering an ADSR_Line that
	/// is created by an ADSR parameter. This 
	/// graph is primarily for debugging.
	/// </summary>
	public class ADSR_Graph : MonoBehaviour {
		...
		/// </summary>
		private ADSR_Line Line { get; set; }
		...
		public void AddPoint() {
			switch (y.State) {
				case ADSR_STATE.ATTACK:
					Line.Add(new ADSR_Point(y.State, y.Value, y.TotalTime, y.StateTime));
