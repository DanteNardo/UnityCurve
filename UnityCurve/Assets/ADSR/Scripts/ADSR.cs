...
namespace UnityCurve {
    ...
    public class ADSR : MonoBehaviour {
        ...
        public Curve[] positiveCurves;
        public Curve[] negativeCurves;
        ...
        public ADSR_Line Simulate(float sustainTime) {
            // Prepare simulated line and start attack
            ADSR_Line simulatedLine = new ADSR_Line();
            ...
            while (State != ADSR_STATE.NONE) {
                 ...
                 */
                UpdateADSR();
                simulatedLine.Add(new ADSR_Point(State, Value, TotalTime, StateTime));
